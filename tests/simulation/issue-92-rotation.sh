...
MASTER_RU_01="master-ru-01"
MASTER_RU_02="master-ru-02"
ENDPOINT_US_01="endpoint-us-01"
...
# ---------------------------------------------------------------------------
# Generate ephemeral compose file
# ---------------------------------------------------------------------------
...
services:
  ${MASTER_RU_01}:
    ...
    entrypoint:
      ...
      - -c
      - |
        [ -f /config/mesh.token ] || echo 'test-token-placeholder' > /config/mesh.token
...
# ---------------------------------------------------------------------------
# Generate ephemeral topology file
# ---------------------------------------------------------------------------
cat > "${TOPO_FILE}" <<EOF
overlay:
...
# ---------------------------------------------------------------------------
# Prepare endpoint (generates keypair, token, compose file).
# ---------------------------------------------------------------------------
echo ""
echo "[prep] Preparing masters and endpoint..."
