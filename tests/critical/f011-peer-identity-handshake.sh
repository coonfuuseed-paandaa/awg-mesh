...
echo "PASS - f011-peer-identity-handshake.sh: master self-registration, egress/clientd registration, registered-client transit allowed_ips on egress, egress self-route exclusion, master-first packet transit, and non-zero handshake"
