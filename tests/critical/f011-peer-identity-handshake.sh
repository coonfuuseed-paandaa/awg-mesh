...
echo "PASS - f011-peer-identity-handshake.sh: master self-registration and egress clientd registration drive endpoint-aware peer config, client peer-list transit allowed_ips, egress self-route exclusion, master-first packet transit, and non-zero handshake"
