...
go test -count=1 ./cmd/mesh-ctl/cmd -run 'TestRunNodePrepareCommand(WritesMikrotikContainerRouterOSScript|RequiresMikrotikControlPlane|WritesLegacyMikrotikContainerDialect)|TestPrepareMikrotikNativeWireGuardRouterOSRemainsDeferredGenerator'
